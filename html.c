                 ...
                 char ** addl_head_ptr, const char ** body_attr_ptr, char ** body_content_ptr)
{
  ...
  static const char * table_caption =
    "<caption>Generated by <a style=\"font-variant: small-caps\" target=\"_blank\" href=\"https://jeffbourdier.github.io/dumprows\">DumpRows</a></caption>";
  ...
  if (!info_count)
  {
    ...
    *body_attr_ptr = NULL;
    *(p = (char *)malloc(m = (k = strlen(table_caption)) + (n = strlen(rows)) + 1)) = '\0';
    text_append(p, m, table_caption, k);
  ...
  *body_content_ptr = (char *)malloc(m += strlen(body_format) + strlen(table_caption));
  text_format(*body_content_ptr, m, body_format, table_caption, q);
  free(p); free(q);
}

                 ...
                 char ** addl_head_ptr, const char ** body_attr_ptr, char ** body_content_ptr)
{
  ...
  static const char * head_format =
    ...
    "<script type=\"text/javascript\"><!--\r\n"
      ...
      "{ tableDiv = document.getElementById('tableDiv'); "
        ...
        "backPolygon = L.polygon([null], { color: 'aqua', fillOpacity: 1, weight: 7 }); "
      ...
      "{ clearSelection(); "
        ...
        "{ case 'Point': "
          ...
          "case 'LineString': "
            ...
            "break; "
          "case 'Polygon': "
            "var latLngs = L.GeoJSON.coordsToLatLngs(selectedGeometry.coordinates, 1); "
      ...
      "{ if (selectedIndex < 1) return; "
        ...
        "{ case 'Point': var latLng = forePoint.getLatLng(); bounds = L.latLngBounds(latLng, latLng); break; "
          ...
          "case 'Polygon': bounds = forePolygon.getBounds(); break; "
          "default: return; "
        "} "
      ...
      "{ if (selectedIndex < 1) return; "
        ...
        "{ case 'Point': latLng = forePoint.getLatLng(); break; "
          ...
          "case 'Polygon': latLng = forePolygon.getCenter(); break; "
          "default: return; "
        "} "
        "map.panTo(latLng); "
      "} "
  ...
  static const char * body_format = "<div id=\"tableDiv\"><table>%s</table></div><div id=\"mapDiv\"></div>";
